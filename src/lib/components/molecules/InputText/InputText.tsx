...
import { InputField } from 'src/lib/components/atoms/InputField';
import { InputEmail } from 'src/lib/components/atoms/InputEmail';
import { InputPassword } from 'src/lib/components/atoms/InputPassword';
import { TextArea } from 'src/lib/components/atoms/TextArea';
import { Text } from 'src/lib/components/atoms/Text';
...
const InputText: Component<IProps> = ({
    initialValue,
    label,
    error,
    errorMessage,
